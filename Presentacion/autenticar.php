...
if (isset($_POST["autenticar"])) {
  ...
  if ($usuario->autenticar()) {
    ...
    header("Location: ?pid=" . base64_encode("Presentacion/usuario/inicioUsuario.php"));
    exit;
  }
  ...
  if ($colaborador->autenticar()) {
    ...
    header("Location: ?pid=" . base64_encode("Presentacion/colaborador/inicioColaborador.php"));
    exit;
  }
...
<head>
  ...
  <style>
    ...
    .login-info-box { left: 0; }
    .register-info-box { right: 0; }
    ...
    <div class="white-panel">
      ...
      <div class="register-show">
        <div class="text-center mt-5">
          <h2>Registro</h2>
          <p class="mt-3">¿Deseas registrarte?</p>
          <a href="?pid=<?php echo base64_encode('Presentacion/registroUsuario.php'); ?>" class="btn btn-green mt-2">Registrarme</a>
        </div>
      </div>
    </div>
  </div>
